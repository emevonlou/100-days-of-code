...
**Thoughts:** Feeling closer to the end of the react session (I need to celebrate a lot when that day arrives - synchronizing the freecodecamp with my react course from udemy has done me a huge good). Conclude three more items from freecodecamp, put algorithm in js in github and now I'm studying for college proof (project management). My biggest problem has been the weather. But it will work!
...
**Today's Progress**: React and Redux(in progress)

**Thoughts:** Today was a very difficult day. But I managed to get here in time to try to make it easier with react and redux (it did not go exactly as I planned), but as I studied, we should always be prepared for unpredictability in the code world, although this may seem illogical. Concludes a few more items from the react / redux session. I put algorithm in github and wait tomorrow to complete the planned.
...
**Today's Progress**: React and Redux(Completed)

**Thoughts:** I was able to complete before my 100 days of code finish (YAYYYY)! I arrived in a part of the Freecodecamp that I love (Projects are always our second affirmation). I hope to start them as soon as possible (I hope they leave the time I dreamed and I dreamed a lot about it). My experience with React / Redux was difficult but very happy, I want to say vehemently with code! Gratitude to all, for the patience, the tolerance, the affability and empathy with my difficulties. Every step ahead of me is ours. And it is not only part of a "process," but of the beginning, of the roots, and these things, are eternal.
